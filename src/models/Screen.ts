...
export class Screen implements IScreen {
    ...
    constructor(local_ip_address: string, raspberry_pi_id: number, type: EScreenType = EScreenType.SLAVE, number_of_screens: number = 1, video_file_playlist: IPlaylistEntry[] = []) {
        this.id = v4();
